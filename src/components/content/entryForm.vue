        ...
        <el-card class="box-card" v-if="!isSubmit">
            ...
            <el-form ref="form" :model="form" label-width="95px" label-position="left" :rules="rules">
                ...
                <el-form-item label="是否注册">
                    <el-input v-model="form.register" type="textarea" :autosize="{ minRows: 2}"></el-input>
                </el-form-item>
        ...
        <div v-else class="success-info">
            <el-card class="s-card">
                <div class="success-card">
                    ...
                    <span>
                    您的申请提交成功，<span style="color:red">{{time}}</span>秒后返回首页
                    </span>
                </div>
            </el-card>
        </div>
        ...
        if (valid) {
          axios({
            ...
            data: {
              ...
              HasRegistered: this.form.register.trim() != "" ? true : false,
              RegisterPlace: this.form.register.trim(),
